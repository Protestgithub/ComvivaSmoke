...
@test
    ...
    Scenario: To verify that Admin user can check all the Order Details of a customer/ business users successfully.
   	 Given Login into Mobiquity Portal as System admin Maker
        When  Click on user management and Manage users
        And  Enter Mobile number and KYC number in search menu for customer or business users
        And  Click on view Details
        Then Click on order details for customer or business users
...
@test
    ...
    Given Login into Mobiquity Portal as System admin Maker
        When  Click on user management and Manage users
        And  Enter Mobile numberin search Menu for orderdetails
        And  Click on view Details
