...
And('Enter Mobile numberin search Menu for orderdetails', function () {
  cy.wait(3000)
...
And('Enter Mobile number and KYC number in search menu for customer or business users', function () {
  cy.wait(3000)
...
Then('Click on order details for customer or business users', function () {
  cy.wait(3000)
  manageUsersPage.getOrderDetailsButton().click({ force: true })
