...
Then('Enter amount and click on confirm', function () {
  ...
  cy.wait(3000)
  //stockManagementPage.getReimbursementMessage().should('contain.text', this.data17.reimbursementinitiated)
  stockManagementPage.getReimbursementErrorMessage().should('contain.text', this.data17.stockReimbursementErrorMessage)
